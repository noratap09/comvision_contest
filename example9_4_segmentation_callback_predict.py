...
checkpoint = ModelCheckpoint('my_model_final_in_480_f_16.h5', verbose=1, monitor='val_iou',save_best_only=True, mode='max')


class ShowPredictSegment(Callback):
    def on_epoch_end(self, epoch, logs={}):
        testfileloc = ['textlocalize/validation/Input/451.jpg',
                       'textlocalize/validation/Input/452.jpg',
                       'textlocalize/validation/Input/453.jpg',
                       'textlocalize/validation/Input/454.jpg']
...
model.save('my_model_final_in_480_f_16_end.h5')
